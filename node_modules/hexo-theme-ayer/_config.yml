...
# 网站图标和侧边栏logo
favicon: /A.ico
logo: /images/A.svg # /images/ayer-side.svg

# 封面配置
# enable-是否启用封面；path-封面背景图；logo-封面logo
cover:
  enable: true
  path: https://pic.imgdb.cn/item/651e7725c458853aef2e6a1d.png # /source/images目录下附送多张美图，可更换
...
leancloud:
  enable: true
  app_id: IVuP9zi4S6BX0nIcZAzNg2Ts-gzGzoHsz
  app_key: NPI07BVNdqTJnNuQhKi8gP1F
# Valine配置
valine:
  enable: true # 是否启用
